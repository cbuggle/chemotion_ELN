...
describe ReactionProcessEditor::Automation::OntologiesAPI, '.put /ontologies/:id/ontology_device_methods' do
                ...
                analysis_defaults: [
                  {
                    ...
                    data_type: 'WAVELENGTHRANGE', metric_name: 'WAVELENGTHS',
                  },
                ],
              },
              {
                ...
                analysis_defaults: [
                  {
                    label: 'Temperature', values: { unit: 'CELSIUS', value: '30' },
                    data_type: 'METRIC', metric_name: 'TEMPERATURE',
                  },
                ],
              },
              {
                ...
                analysis_defaults: [
                  {
                    label: 'Parameter', values: '1000,700 V',
                    data_type: 'TEXT', metric_name: 'MS_PARAMETER',
                  },
                ],
              },
            ],
  ...
  context 'with an omitted existing method' do
    ...
    it 'removes the method from the ontology' do
      api_call

      expect(method.reload.ontology).to be_nil
    end
  end
  ...
  context 'with an empty method list' do
    ...
    it 'clears all methods from the ontology' do
      api_call

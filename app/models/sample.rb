...
class Sample < ApplicationRecord
  ...
  scope :sample_or_startmat_or_products, lambda {
    joins('left join reactions_samples rs on rs.sample_id = samples.id').where("rs.id isnull or rs.\"type\" in ('ReactionsIntermediateSample', 'ReactionsProductSample', 'ReactionsStartingMaterialSample')")
  }
  ...
  def has_density
    density&.positive? && molarity_value.to_i.zero?
  end

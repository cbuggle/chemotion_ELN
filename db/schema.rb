...
ActiveRecord::Schema.define(version: 20_240_917_085_816) do
  ...
  create_table 'calendar_entries', force: :cascade do |t|
    ...
    t.index %w[eventable_type eventable_id], name: 'index_calendar_entries_on_eventable_type_and_eventable_id'
  end
  ...
  create_table 'code_logs', id: :uuid, default: -> { 'uuid_generate_v4()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[source source_id], name: 'index_code_logs_on_source_and_source_id'
  end
  ...
  create_table 'collections_celllines', force: :cascade do |t|
    ...
    t.datetime 'deleted_at'
    t.index %w[cellline_sample_id collection_id], name: 'index_collections_celllines_on_cellsample_id_and_coll_id',
                                                  unique: true
  ...
  create_table 'collections_elements', id: :serial, force: :cascade do |t|
    ...
    t.index %w[element_id collection_id], name: 'index_collections_elements_on_element_id_and_collection_id',
                                          unique: true
  ...
  create_table 'collections_reactions', id: :serial, force: :cascade do |t|
    ...
    t.index %w[reaction_id collection_id], name: 'index_collections_reactions_on_reaction_id_and_collection_id',
                                           unique: true
  end
  ...
  create_table 'collections_research_plans', id: :serial, force: :cascade do |t|
    ...
    t.index %w[research_plan_id collection_id], name: 'index_collections_research_plans_on_rplan_id_and_coll_id',
                                                unique: true
  end
  ...
  create_table 'collections_samples', id: :serial, force: :cascade do |t|
    ...
    t.index %w[sample_id collection_id], name: 'index_collections_samples_on_sample_id_and_collection_id',
                                         unique: true
  end
  ...
  create_table 'collections_screens', id: :serial, force: :cascade do |t|
    ...
    t.index %w[screen_id collection_id], name: 'index_collections_screens_on_screen_id_and_collection_id',
                                         unique: true
  end
  ...
  create_table 'collections_vessels', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[vessel_id collection_id], name: 'index_collections_vessels_on_vessel_id_and_collection_id',
                                         unique: true
  ...
  create_table 'collections_wellplates', id: :serial, force: :cascade do |t|
    ...
    t.index %w[wellplate_id collection_id], name: 'index_collections_wellplates_on_wellplate_id_and_collection_id',
                                            unique: true
  end
  ...
  create_table 'container_hierarchies', id: false, force: :cascade do |t|
    ...
    t.index %w[ancestor_id descendant_id generations], name: 'container_anc_desc_udx', unique: true
  ...
  create_table 'containers', id: :serial, force: :cascade do |t|
    ...
    t.index %w[containable_type containable_id], name: 'index_containers_on_containable'
  end
  ...
  create_table 'devices', force: :cascade do |t|
    ...
    t.index ['name_abbreviation'], name: 'index_devices_on_name_abbreviation', unique: true,
                                   where: '(name_abbreviation IS NOT NULL)'
  end
  ...
  create_table 'literals', id: :serial, force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.string 'litype'
    t.index %w[element_type element_id literature_id category], name: 'index_on_element_literature'
    t.index %w[literature_id element_type element_id], name: 'index_on_literature'
  end
  ...
  create_table 'measurements', force: :cascade do |t|
    ...
    t.index %w[source_type source_id], name: 'index_measurements_on_source_type_and_source_id'
  ...
  create_table 'molecule_names', id: :serial, force: :cascade do |t|
    ...
    t.index %w[user_id molecule_id], name: 'index_molecule_names_on_user_id_and_molecule_id'
  ...
  create_table 'molecules', id: :serial, force: :cascade do |t|
    ...
    t.index %w[inchikey is_partial], name: 'index_molecules_on_inchikey_and_is_partial', unique: true
  end
  ...
  create_table 'nmr_sim_nmr_simulations', id: :serial, force: :cascade do |t|
    ...
    t.index %w[molecule_id source], name: 'index_nmr_sim_nmr_simulations_on_molecule_id_and_source', unique: true
  end
  ...
  create_table 'notifications', id: :serial, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[message_id user_id], name: 'index_notifications_on_message_id_and_user_id', unique: true
  end
  ...
  create_table 'ols_terms', id: :serial, force: :cascade do |t|
    ...
    t.index %w[owl_name term_id], name: 'index_ols_terms_on_owl_name_and_term_id', unique: true
  end
  ...
  create_table 'predictions', id: :serial, force: :cascade do |t|
    ...
    t.index %w[predictable_type predictable_id], name: 'index_predictions_on_predictable_type_and_predictable_id'
  end
  ...
  create_table 'private_notes', force: :cascade do |t|
    ...
    t.index %w[noteable_type noteable_id], name: 'index_private_notes_on_noteable_type_and_noteable_id'
  end
  ...
  create_table 'reactions_samples', id: :serial, force: :cascade do |t|
    ...
    t.jsonb 'gas_phase_data',
            default: { 'time' => { 'unit' => 'h', 'value' => nil }, 'temperature' => { 'unit' => '°C', 'value' => nil },
                       'turnover_number' => nil, 'part_per_million' => nil, 'turnover_frequency' => { 'unit' => 'TON/h', 'value' => nil } }
  ...
  create_table 'subscriptions', id: :serial, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[channel_id user_id], name: 'index_subscriptions_on_channel_id_and_user_id', unique: true
  end
  ...
  create_table 'sync_collections_users', id: :serial, force: :cascade do |t|
    ...
    t.index %w[shared_by_id user_id fake_ancestry], name: 'index_sync_collections_users_on_shared_by_id'
    t.index %w[user_id fake_ancestry], name: 'index_sync_collections_users_on_user_id_and_fake_ancestry'
  end
  ...
  create_table 'text_templates', id: :serial, force: :cascade do |t|
    ...
    t.index ['name'], name: 'index_predefined_template', unique: true,
                      where: "((type)::text = 'PredefinedTextTemplate'::text)"
  ...
  create_table 'users', id: :serial, force: :cascade do |t|
    ...
    t.hstore 'layout',
             default: { 'sample' => '1', 'screen' => '4', 'reaction' => '2', 'wellplate' => '3', 'research_plan' => '5' }, null: false
    ...
    t.index ['name_abbreviation'], name: 'index_users_on_name_abbreviation', unique: true,
                                   where: '(name_abbreviation IS NOT NULL)'
